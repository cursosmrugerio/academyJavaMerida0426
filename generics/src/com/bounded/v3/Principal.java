...
public class Principal {
	...
	public static void main(String[] args) {
		...
		List<Object> otherList1 = list;
		List<?> otherList2 = new ArrayList<Object>();;
		
		List<String> listString = new ArrayList<>();
		listString.add("A");
		listString.add("B");
		listString.add("C");
		//otherList1 = listString;
		otherList2 = listString;
		
		List<Double> listDouble = new ArrayList<>();
		listDouble.add(5.0);
		listDouble.add(2.0);
		listDouble.add(1.7);
		List<?> lista = listDouble;
		//List<? extends Figura> listaFiguraX = listDouble;
		
		List<Figura> listFigura = new ArrayList<>();
		listFigura.add(new Circulo());
		listFigura.add(new Cuadrado());
		listFigura.add(new Triangulo());
		List<? extends Figura> listaFigura = listFigura;

		List<Circulo> listCirculo = new ArrayList<>();
		listCirculo.add(new Circulo());
		listCirculo.add(new Circulo());
		listCirculo.add(new Circulo());
		listaFigura = listCirculo;
